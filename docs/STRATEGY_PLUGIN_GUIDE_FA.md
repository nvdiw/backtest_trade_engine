...
برای پوشه خروجی مستقل، مالکیت checkpoint، قفل اجرا و قرارداد ماژول آینده Pulse، [راهنمای workspace استراتژی‌ها](STRATEGY_WORKSPACES_FA.md) را رعایت کنید. تنظیمات و grid هر استراتژی باید متعلق به خودش باشند؛ اضافه‌کردن پلاگین نباید تنظیمات MA را تغییر دهد.
