...
تمام تاریخچه برای Resume و گزارش‌ها حفظ می‌شود، اما برای جلوگیری از توقف طولانی در کمپین‌های بزرگ، مدل Surrogate حداکثر از ۱۰۲۴ نمونه‌ی نماینده‌ی متوازن از کل طیف امتیازها آموزش می‌بیند. درصد تولید Candidate pool، آموزش مدل و امتیازدهی pool در ترمینال نمایش داده می‌شود.
